      ...
      <section className="w-full flex justify-between my-20">
        ...
        <article className="w-full flex flex-col px-20 justify-center space-y-3">
          ...
          <div className="flex flex-col space-y-2">
            <button className="group w-full h-10 border rounded-md relative flex justify-center items-center hover:border-[#4E61FF] transition-colors ">
            ...
            <button className="group w-full h-10 border rounded-md relative flex justify-center items-center hover:border-[#4E61FF] transition-colors peer">
              <div className="w-10 h-10 aspect-square absolute left-0 flex justify-center items-center text-gray-600 group-hover:text-[#4E61FF] transition-colors">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
